...
},{}],"registerEmail.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sendEmail = exports.registerEmail = void 0;
...
var registerEmail = exports.registerEmail = /*#__PURE__*/function () {
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Register email Daily weather success!');
  ...
  return function registerEmail(_x) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'send email Daily weather success!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
...
var _registerEmail = require("./registerEmail");
var btnSave = document.querySelector('.save-button');
if (btnSave) {
  btnSave.addEventListener('click', function () {
    // Get weather data
    var city = document.querySelector('.weather-desc h5').textContent;
    var wind = document.querySelector('.weather-desc p:nth-child(2)').textContent;
    var humidity = document.querySelector('.weather-desc p:nth-child(3)').textContent;
    var temperature = document.querySelector('.weather-desc p:nth-child(4)').textContent;
    var image = document.querySelector('.weather-image img').src;
    var weatherData = {
      city: city,
      wind: wind,
      humidity: humidity,
    ...
    var exists = savedWeatherData.some(function (savedData) {
      return savedData.city === weatherData.city && savedData.wind === weatherData.wind && savedData.humidity === weatherData.humidity && savedData.temperature === weatherData.temperature && savedData.image === weatherData.image;
    });
  ...
  window.onload = function () {
    ...
    if (savedWeatherData.length > 0) {
      ...
      savedWeatherData.forEach(function (weatherData) {
        ...
        var historyImage = document.createElement('div');
        ...
        var historyDetails = document.createElement('div');
...
if (formEmail) {
  formEmail.addEventListener('submit', function (e) {
    ...
    (0, _registerEmail.registerEmail)(email);
  });
}
var now = new Date();
var tomorrow = new Date(now.getFullYear(), now.getMonth(), now.getDate() + 1);
var msUntilTomorrow = tomorrow - now;
setTimeout(_registerEmail.sendEmail, msUntilTomorrow);
},{"./registerEmail":"registerEmail.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
